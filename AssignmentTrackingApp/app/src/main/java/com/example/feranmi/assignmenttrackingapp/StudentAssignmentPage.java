...
public class StudentAssignmentPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //availableAssignmentBT.list.getAdapter().getCount()
    ...
    private class AvailableAssignmentBT extends AsyncTask<String, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            String student_login_url = "http://www.cc.puv.fi/~e1100617/studentAssignmentPage_1.php";
            course_id = params[0];
    ...
    private class SubmittedAssignmentBT extends AsyncTask<String, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            String student_login_url = "http://www.cc.puv.fi/~e1100617/studentAssignmentPage_2.php";
            course_id = params[0];
