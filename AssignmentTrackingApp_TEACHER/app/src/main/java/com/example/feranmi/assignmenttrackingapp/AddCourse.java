    ...
    public void onHomePage(){
        ...
        homePageTextView.setOnClickListener(
                new View.OnClickListener(){
                    @Override
                    public void onClick(View v){
                        Intent teacherPage = new Intent(AddCourse.this, TeacherPage.class);
                        teacherPage.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            logoutLink.setOnClickListener(
                    new View.OnClickListener(){
                        ...
                        public void onClick(View v){
                            ...
                            Intent loginPage = new Intent(AddCourse.this, TeacherLogin.class);
