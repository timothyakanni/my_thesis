...
public class AddAssignment extends AppCompatActivity implements View.OnClickListener{
    ...
    public void OnAddAssignment(View v){
        ...
        try{
            ...
            if(assignmentId.isEmpty() || description.isEmpty() || startDate.isEmpty() || startTime.isEmpty()
                    || endDate.isEmpty() || endTime.isEmpty() || courseId.isEmpty()){
    ...
    private class TeacherCoursesNameBT extends AsyncTask<String, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            String student_login_url = "http://www.cc.puv.fi/~e1100617/addAssignmentPage_1.php";
            teacher_id = params[0];
    ...
    private class AddAssignmentBT extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String student_register_url = "http://www.cc.puv.fi/~e1100617/addAssignmentPage_2.php";
