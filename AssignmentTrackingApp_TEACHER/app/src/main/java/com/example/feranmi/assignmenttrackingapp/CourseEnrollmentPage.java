...
public class CourseEnrollmentPage extends AppCompatActivity {
    ...
    //This method is used to implement enrollment button
    ...
    private class CourseNameBT extends AsyncTask<String, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            String all_courses_url = "http://www.cc.puv.fi/~e1100617/" +
                    "AssignmentTrackingApp/courseEnrollmentPage_1.php";
            try {
    ...
    private class StudentEnrollmentBT extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String student_enrollment_url = "http://www.cc.puv.fi/~e1100617/" +
                    "AssignmentTrackingApp/courseEnrollmentPage_2.php";
            username = params[0];
            course_id = params[1];
